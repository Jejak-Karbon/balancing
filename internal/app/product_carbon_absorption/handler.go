...
func (h *handler) Get(c echo.Context) error {
	...
	filter := new(dto.FilterProductCarbonAbsorption)
	...
	return res.CustomSuccessBuilder(200, result.Datas, "Get products carbon absorption success", &result.PaginationInfo).Send(c)
}
